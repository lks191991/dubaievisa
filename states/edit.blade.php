...
@section('content')
    ...
    <form action="{{ route('states.update', $record->id) }}" method="post" class="form" enctype="multipart/form-data">
          ...
          <div class="card card-primary">
			...
			@else
              ...
              <div class="form-group col-md-1">
				<br>
                <img src="{{ url('/uploads/state/thumb/'.$record->image) }}" width="50"  alt="airlines-logo" />
              </div>
              @endif
			  </div>
        <div class="form-group">
