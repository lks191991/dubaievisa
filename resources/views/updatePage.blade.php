    ...
    <div class="package-card-tab-section">
        ...
        <div class="container">
             ...
             <div class="package-card-with-tab" >
                 ...
                 <div class="row" style="background-color: #fff;padding: 20px 0px;border-radius:20px;">
                     <div class="col-lg-12" >
                         <div class="tab-content" id="pills-tab4Content">
                             <div class="tab-pane fade show active" id="all" role="tabpanel">
                                    ...
                                    @foreach ($allrecords as $record)
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <a href="javascript:void(0);" class="card-img"><img src="{{ url('/uploads/notification/'.$record->image) }}" alt="" class="img-fluid img-round"></a>
                                                    <div class="batch">
