                    ...
                    <tbody>
                      <tr>
                        <td width="100%"><table style="border-collapse: collapse"  width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                            <tbody>
                              <tr>
                                <td style="color: rgb(1 , 1 , 1)" width="100%" valign="top" height="30">{!!$template->salutation!!} {{$organiser->organiser_name}},<br>
                                   <p> A Signup request has been submitted by a user, the details are as below:</p>

                                    <p>Organiser Name:  {{$organiser->organiser_name}} </p>
                                    <p>Email Address:   {{$organiser->email}}</p>
