...
@section('content')
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Hotel Category Add</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('hotelcategories.index') }}">Hotel Categories</a></li>
              <li class="breadcrumb-item active">Hotel Category Add</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <form action="{{ route('hotelcategories.store') }}" method="post" class="form">
    {{ csrf_field() }}
    <div class="row">
        <div class="col-md-12">
