...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
		@php
		$tourDateArray = SiteHelpers::getDateListHotel($voucher->travel_from_date,$voucher->travel_to_date)
		@endphp
          <div class="card">
			  ...
			  <div class="col-md-12">
                <table class="table table-bordered">
                  <thead>
				   <tr>
                    <th>Room Type</th>
					<th><input type="text" id="room_type1" required name="room_type[]" tabindex="1" class="form-control"    /></th>
					<th colspan="4"></th>
                  </tr>
				   <tr>
                    <th>Number of Rooms</th>
					<th ><input type="text" id="nom_of_room1" required name="nom_of_room[]" tabindex="2" class="form-control onlynumbr"   /></th>
					<th colspan="4"></th>
                  </tr>
				  <tr>
                    <th>Meal Plan</th>
					<th >
						<select name="mealplan[]" id="mealplan1" tabindex="3" class="form-control" required  >
                  ...
                  <tr>
				   ...
				   <tr>
                    <th>Number of Pax</th>
					<td><input type="text" id="nop_s1"  name="nop_s[]" tabindex="4" class="form-control onlynumbrf psingle" data-inputnumber="1" value="0" required  /></td>
					<td><input type="text" id="nop_d1"  name="nop_d[]"  tabindex="7" class="form-control onlynumbrf pdouble" data-inputnumber="1" required  /></td>
					<td><input type="text" id="nop_eb1"  name="nop_eb[]" tabindex="10" class="form-control onlynumbrf peb" data-inputnumber="1" value="0" required  /></td>
                    <td><input type="text" id="nop_cwb1" name="nop_cwb[]" tabindex="13" class="form-control onlynumbrf pcwb" data-inputnumber="1" value="0" required /></td>
                    <td><input type="text" id="nop_cnb1"  name="nop_cnb[]"  tabindex="16" class="form-control onlynumbrf pcnb" data-inputnumber="1" value="0" required  /></td>
                  </tr>
				  <tr>
                    <th>Net Rate</th>
					<td><input type="text" id="nr_s1"  name="nr_s[]" value="0"  tabindex="5" required class="form-control onlynumbrf psingle" data-inputnumber="1" /></td>
					<td><input type="text" id="nr_d1"  name="nr_d[]"  required tabindex="8" class="form-control onlynumbrf pdouble" data-inputnumber="1" required  /></td>
					<td><input type="text" id="nr_eb1"  name="nr_eb[]" value="0"  tabindex="11" required class="form-control onlynumbrf peb "  data-inputnumber="1" /></td>
                    <td><input type="text" id="nr_cwb1" name="nr_cwb[]" value="0" tabindex="14" required class="form-control onlynumbrf pcwb" data-inputnumber="1" /></td>
                    <td><input type="text" id="nr_cnb1"  name="nr_cnb[]" value="0"  tabindex="17" required  class="form-control onlynumbrf pcnb" data-inputnumber="1" /></td>
                  </tr>
				   <tr>
