...
@php
	...
	$priceCal = PriceHelper::getActivityPriceSaveInVoucher($transferOption,implode(',',$activites_id),$voucher->agent_id,$voucher,$bap->ucode,$voucher->adults,$voucher->childs,$voucher->infants,0,$tourDates[0]);
