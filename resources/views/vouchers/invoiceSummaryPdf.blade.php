                    ...
                    <tr>
                        ...
                        <td align="right" valign="top">
                          <p>Invoice No.:  {{($voucher->status_main == 5)?$voucher->invoice_number:$voucher->code}}</p>
							<p>Invoice Date.: {{($voucher->booking_date)? date("d-M-Y",strtotime($voucher->booking_date)): date("d-M-Y",strtotime($voucher->created_at))}}</p>
...
Branch Name: Bur Dubai Branch</p>
                      ...
                      <strong>Commercial Bank of Dubai (CBD)</strong>
                      <p style="line-height: 12pt;">ABATERA TOURISM LLC<br/>
