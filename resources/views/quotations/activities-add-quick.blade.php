...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Quotation Activities Add</h1>
      </div>
      <div class="col-sm-6">
...
<input type="hidden" id="row_cont" name="row_cont" value="10" >


<div class="row" style="height:300px; overflow:auto; ">
@foreach ($activityVariants as $avrecord)
<div class="col-md-4">
<h6>{{ $avrecord->ActivityVariantName }} <button type="button" class="btn btn-sm btn-success" onClick="funAdd('{{ $avrecord->ActivityVariantName }}',{{ $avrecord->id }});">+</button> </h2>
</div>
@endforeach
</div>
    ...
    <table id="example1" class="table rounded-corners">
        ...
        <tbody id="dynamic-rows">
            ...
            <tr>
                ...
                <td><input type="text" id="adult_{{ $i }}" name="adult[]" value="{{$voucher->adults}}" class="form-control"  ></td>
                <td><input type="text" id="child_{{ $i }}" name="child[]" value="{{$voucher->childs}}" class="form-control" ></td>
                <td><input type="text" id="infant_{{ $i }}" name="infant[]" value="{{$voucher->infants}}" class="form-control" ></td>
