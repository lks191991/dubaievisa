          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" id="name" name="name" value="{{ old('name') ?: $role->name }}" class="form-control"  placeholder="Name" />
                @if ($errors->has('name'))
              ...
              <div class="form-group">
                ...
                <select name="status" id="status" class="form-control">
                    <option value="1" @if($role->status ==1) {{'selected="selected"'}} @endif>Active</option>
					          <option value="0" @if($role->status ==0) {{'selected="selected"'}} @endif >Inactive</option>
                 </select>
              </div>
            </div>
            <!-- /.card-body -->
