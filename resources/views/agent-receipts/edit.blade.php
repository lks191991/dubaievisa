            ...
            <div class="card-body row">
              ...
              <div class="form-group col-md-3">
                ...
                <select name="mode_of_payment" id="mode_of_payment" required='required' class="form-control">
                    ...
                    <option value="1" @if($agentAmounts->mode_of_payment =='1') {{'selected="selected"'}} @endif>Bank Account 1</option>
					          <option value="2" @if($agentAmounts->mode_of_payment =='2') {{'selected="selected"'}} @endif >Bank Account 2</option>
                    <option value="3" @if($agentAmounts->mode_of_payment =='3'){{'selected="selected"'}} @endif >Bank Account 3</option>
			  ...
			  <div class="form-group col-md-6">
                <label for="inputName">Remark:</label>
                 <input type="text" id="remark" name="remark" value="{{ $agentAmounts->remark }}" class="form-control"  placeholder="Remark" />
