...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tFileIcon = '<i class="bi bi-file-earmark"></i>';
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    uploadRetryIcon: '<i class="bi bi-repeat"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            ...
            toggleheader: '<i class="bi bi-arrows-angle-expand"></i>',
            fullscreen: '<i class="bi bi-fullscreen"></i>',
            borderless: '<i class="bi bi-aspect-ratio"></i>',
